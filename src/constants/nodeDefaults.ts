...
export const NODE_DEFAULTS: Record<NodeType, Partial<NodeData>> = {
  'server': {
    label: '我的网站', listenAddr: '0.0.0.0', port: 80, ssl: false, sslCert: '/etc/nginx/ssl/fullchain.pem', sslKey: '/etc/nginx/ssl/privkey.pem',
    serverName: 'example.com', aliases: '', root: '/var/www/html', index: 'index.html index.htm',
    http2: false, sslProtocols: 'TLSv1.2 TLSv1.3', sslStapling: false, sslStaplingVerify: false, sslTrustedCert: '',
    addHeaders: '', clientMaxBodySize: '', accessLog: '', errorLog: '', listenIPv6: '::', ipv6Port: 80,
    gzip: true, gzipTypes: 'text/plain text/css application/json application/javascript text/xml application/xml application/xml+rss text/javascript', gzipMinLength: '1000', redirectHttp: false, chunkedTransfer: true, extra: '',
  },
  'location': {
    label: '首页', path: '/', mode: 'static', proxyPass: '', fastcgiPass: '', xff: true, blockStatus: 403,
    redirectUrl: '', redirectPermanent: true, blockPage: '', allow: '', deny: '', includes: '', fastcgiIndex: '', fastcgiParams: '',
    root: '/var/www/html', index: 'index.html index.htm', tryFiles: '', expires: '30d', autoindex: false, cacheControl: '', chunkedTransfer: true, accessLog: '', errorLog: '', extra: '',
  },
  'upstream': {
