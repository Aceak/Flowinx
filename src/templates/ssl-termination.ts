export const sslTermination = {
  ...
  nodes: [
    { id: 's1', type: 'server', position: { x: 250, y: 50 }, data: { label: '安全站点', listenAddr: '', port: 443, ssl: true, sslCert: '/etc/nginx/ssl/fullchain.pem', sslKey: '/etc/nginx/ssl/privkey.pem', serverName: 'secure.example.com', aliases: '', hasStatic: false, root: '', index: '' } },
