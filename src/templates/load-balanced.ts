export const loadBalanced = {
  ...
  nodes: [
    { id: 's1', type: 'server', position: { x: 250, y: 50 }, data: { label: 'api.example.com', listenAddr: '', port: 80, ssl: false, sslCert: '/etc/nginx/ssl/fullchain.pem', sslKey: '/etc/nginx/ssl/privkey.pem', serverName: 'api.example.com', aliases: '', hasStatic: false, root: '', index: '' } },
    ...
    { id: 'u1', type: 'upstream', position: { x: 250, y: 380 }, data: { label: 'api_backend', name: 'api_backend', strategy: 'least-conn', keepalive: 32 } },
    { id: 'b1', type: 'backend', position: { x: 150, y: 540 }, data: { label: '10.0.0.1:3000', address: '10.0.0.1:3000', weight: 2, maxFails: 3, failTimeout: 30, backup: false } },
    { id: 'b2', type: 'backend', position: { x: 350, y: 540 }, data: { label: '10.0.0.2:3000', address: '10.0.0.2:3000', weight: 1, maxFails: 3, failTimeout: 30, backup: false } },
  ],
  edges: [
