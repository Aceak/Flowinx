export const simpleProxy = {
  ...
  nodes: [
    ...
    { id: 'l1', type: 'location', position: { x: 100, y: 220 }, data: { label: 'API 接口', path: '/api', mode: 'proxy', proxyPass: 'http://127.0.0.1:3000', root: '', useIndex: false, index: 'index.html index.htm', xff: true, blockStatus: 403, allow: '', deny: '', extra: '' } },
    { id: 'l2', type: 'location', position: { x: 370, y: 220 }, data: { label: '静态首页', path: '/', mode: 'static', proxyPass: '', root: '', useIndex: false, index: 'index.html index.htm', xff: false, blockStatus: 403, allow: '', deny: '', extra: '' } },
  ],
  edges: [
